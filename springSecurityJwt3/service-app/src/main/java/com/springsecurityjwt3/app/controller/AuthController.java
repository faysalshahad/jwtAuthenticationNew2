...
import com.springsecurityjwt3.security.service.AuthService;
...
public class AuthController {
        ...
        public ResponseEntity<AuthResponse> register(@RequestBody RegisterRequest request) {
                ...
                try {
                        ...
                        return ResponseEntity.ok(
                                        new AuthResponse(
                                                        "User " + request.getUsername() + " registered successfully",
                                                        null));
        ...
        // return ResponseEntity.ok(new AuthResponse("Successfully logged out", null,
        // null));
        // }
        ...
        public ResponseEntity<?> logout(HttpServletRequest request) {
                ...
                // Create a "Clear" cookie for Refresh Token
                ...
                // String username =
                // jwtUtil.getuserNameFromToken(extractTokenFromCookie(request));
        ...
        // @PostMapping("/refresh")
        // public ResponseEntity<AuthResponse> refresh(@RequestBody TokenRefreshRequest
        // request) {
        ...
        @GetMapping("/users")
        // @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'ADMIN', 'USER')") // Everyone
